...
const dataStoreTow = {
  daily: {
    ...
    visitors: [],
    sales: [],
    note: "لا توجد بيانات زيارات مسجلة بعد.",
  },
  weekly: {
...
const analyticsChartTow = new AnalyticsChart(ctxTow, {
  type: "bar",
  data: {
...
function updateChartTow(period, btn) {
  document
    .querySelectorAll(".filter-btn-tow")
    .forEach((b) => b.classList.remove("active-tow"));
