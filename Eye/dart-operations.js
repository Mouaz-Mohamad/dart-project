...
// ============================================================================
 ...
 // and transactional UI synchronization.
 // ============================================================================

(function () {
  'use strict';
  window.DartOperations = Object.freeze({ active: true });
  ...
  const write = (key, value) => {
    ...
    window.DartState?.write?.(key, value, { source: 'operations' });
  };
...
if (typeof dartMoney === 'function') {
  ...
  if (orderForm) { orderForm.dataset.dartV3 = '1'; orderForm.dataset.dartV2 = '1'; orderForm.dataset.dartOperations = '1'; }
  if (repForm) { repForm.dataset.dartV3 = '1'; repForm.dataset.dartV2 = '1'; repForm.dataset.dartOperations = '1'; }
  ...
  function bindOrderModal() {
    if (!orderForm || orderForm.dataset.dartOperationsBound) return;
    orderForm.dataset.dartOperationsBound = '1';
    let selected = [];
  ...
  function renderRepresentativesOperations(dataArray) {
  ...
  function bindRepModalOperations() {
    if (!repForm || repForm.dataset.dartOperationsBound) return;
    repForm.dataset.dartOperationsBound = '1';
  ...
  function enhanceEditModal() {
    if (typeof openEditModal !== 'function' || openEditModal.dartOperationsWrapped) return;
    ...
    wrapped.dartOperationsWrapped = true; openEditModal = wrapped;
  }
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    bindOrderModal();
    bindRepModalOperations();
    bindDashboardActions();
    enhanceEditModal();
    if (typeof renderRepresentative === 'function') {
      renderRepresentative = renderRepresentativesOperations;
